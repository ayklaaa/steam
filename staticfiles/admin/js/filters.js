...
{
    // Init filters.
    let filters = JSON.parse(sessionStorage.getItem('django.admin_panel.filtersState'));
    ...
    details.forEach(detail => {
        detail.addEventListener('toggle', event => {
            ...
            sessionStorage.setItem('django.admin_panel.filtersState', JSON.stringify(filters));
        });
    });
}
